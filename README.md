...
GitHub Repository
Clone the initial dotnet-hello-world repository and push it to your own GitHub account with updates.
...
cd d2k-ass
Update .NET Core Version: Ensure compatibility with your environment by updating to a supported .NET Core version if necessary.

Add Dockerfile and Jenkinsfile: Add the Dockerfile and Jenkinsfile to the project.

For file contents, refer to your GitHub repository: Ajeet664/d2k-ass
...
Set the Payload URL to your Jenkins server URL followed by /github-webhook/ (e.g., http://98.84.242.50:8080/github-webhook/).
Set Content type to application/json.
Select Just the push event.
Create Jenkins Pipeline Job:

In Jenkins, create a new Pipeline job.
Connect it to your GitHub repository (e.g., https://github.com/Ajeet664/d2k-ass.git).
Set the pipeline definition to use the Jenkinsfile from your repository.
